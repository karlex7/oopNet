...
namespace ClassLibrary.MODEL
{
    ...
    public partial class Match
    {
        public static List<Match> FromJson(string json) => JsonConvert.DeserializeObject<List<Match>>(json, ClassLibrary.MODEL.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this List<Match> self) => JsonConvert.SerializeObject(self, ClassLibrary.MODEL.Converter.Settings);
    }
